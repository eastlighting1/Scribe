...
중이라면 먼저 [캡처 패턴](C:/Users/eastl/MLObservability/Scribe/docs/ko/capture-patterns.md)
부터 읽는 편이 좋습니다. degraded outcome이나 dispatch failure를 이해하려는 중이라면
[Degradation과 오류](C:/Users/eastl/MLObservability/Scribe/docs/ko/degradation-and-errors.md)
와 함께 이 페이지를 읽는 것이 가장 좋습니다.

## 패키지 진입점

top-level package export는
[src/scribe/__init__.py](C:/Users/eastl/MLObservability/Scribe/src/scribe/__init__.py)에
...
와
[src/scribe/results/__init__.py](C:/Users/eastl/MLObservability/Scribe/src/scribe/results/__init__.py)
...
이해하려면 [아티팩트](C:/Users/eastl/MLObservability/Scribe/docs/ko/artifacts.md)를
함께 읽는 것이 좋습니다.
...
[싱크와 저장소](C:/Users/eastl/MLObservability/Scribe/docs/ko/sinks-and-storage.md)를 함께
보는 것이 가장 좋습니다.

## Exception

public exception type은
[src/scribe/exceptions.py](C:/Users/eastl/MLObservability/Scribe/src/scribe/exceptions.py)에
